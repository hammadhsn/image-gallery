  ...
  return (
    <div className='max-w-sm mx-auto my-10 overflow-hidden rounded'>
      <form onSubmit={onSubmit} className="w-full max-w-sm">
        ...
        <button className="flex-shrink-0 px-2 py-1 text-sm text-white bg-indigo-400 border-4 border-teal-500 rounded hover:bg-teal-700 hover:border-teal-700" type="submit">
      Search
      </button>
      </div>
      </form>
